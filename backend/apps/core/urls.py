...
from .views import EnvironmentConfigurationViewSet, SystemHealthAPIView, UnifiedNotificationConfigViewSet
from .views_notification import NotificationTemplateViewSet

router = DefaultRouter()
router.register(r'environment-configurations', EnvironmentConfigurationViewSet, basename='environment-configuration')
