...
export function getGenerationConfigs(params) {
  return request({
    url: '/requirement-analysis/ai-gen/params/',
    method: 'get',
    params
  })
}
...
export function getGenerationConfigDetail(id) {
  return request({
    url: `/requirement-analysis/ai-gen/params/${id}/`,
    method: 'get'
  })
}
...
export function getActiveGenerationConfig() {
  return request({
    url: '/requirement-analysis/ai-gen/params/active/',
    method: 'get'
  })
}
...
export function getAIModelConfigs(params) {
  return request({
    url: '/requirement-analysis/ai-gen/models/',
    method: 'get',
    params
  })
}
...
export function getActiveAIModelConfig(modelType, role) {
  return request({
    url: '/requirement-analysis/ai-gen/models/active/',
    method: 'get',
...
export function updateAIModelConfig(id, data) {
  return request({
    url: `/requirement-analysis/ai-gen/models/${id}/`,
    method: 'put',
    data
  })
}
...
export function getPromptConfigs(params) {
  return request({
    url: '/requirement-analysis/ai-gen/prompts/',
    method: 'get',
    params
  })
}
...
export function getActivePromptConfig(promptType) {
  return request({
    url: '/requirement-analysis/ai-gen/prompts/active/',
    method: 'get',
...
export function updatePromptConfig(id, data) {
  return request({
    url: `/requirement-analysis/ai-gen/prompts/${id}/`,
    method: 'put',
    data
  })
}
