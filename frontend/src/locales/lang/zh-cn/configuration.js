export default {
  ...
  aiMode: {
    ...
    topP: 'Top P',
    samplingHint: 'GPT-5、o1、o3、o4 等推理模型不支持采样参数时将自动忽略 Temperature 和 Top P；Kimi 使用其要求的 Temperature 1。',
    enableConfig: '启用此配置',
  ...
  aiModePrompt: {
    ...
    configName: '配置名称',
    configNamePlaceholder: '例如：文本模式默认提示词',
    promptType: '提示词类型',
    ...
    chars: '字符',
    enableConfig: '启用此配置',
    enableHint: '启用后，同一类型下其他已启用的配置将自动禁用',
    preview: '预览',
    saving: '保存中...',
    loading: '加载中...',
    confirmLoad: '确认加载',
    defaultsPreview: '默认提示词预览',
    noContent: '暂无内容',
    createdBy: '创建者',
    emptyTitle: '暂无提示词配置',
    ...
    messages: {
      ...
      deleteConfirm: '确定要删除此提示词配置吗？',
      loadDefaultsFailed: '加载默认提示词失败',
      defaultsLoaded: '默认提示词加载成功'
    }
  },
